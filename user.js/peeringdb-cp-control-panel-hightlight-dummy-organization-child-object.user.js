...
(function() {
  'use strict';
  console.warn('[Deprecated] PeeringDB CP - Control Panel Hightlight Dummy Organization child object has been replaced by PeeringDB CP - Consolidated Tools (install: peeringdb-cp-consolidated-tools.user.js).');
