...
(function() {
  'use strict';
  console.warn('[Deprecated] PeeringDB FP - Copy record to Clipboard has been replaced by PeeringDB FP - Consolidated Tools (install: peeringdb-fp-consolidated-tools.user.js).');
